...
<HTText textColor='#233465' bold size={Fonts.size.font12} text={"Login to your account to continue your courses"}/>
<HTButton 
...
<Text style={styles.text}>{"You can learn more about our privacy and how we use your information in our Privacy Policy by creating an account confirm that i have read and agreed to the Terms of use"}</Text>
</View>
        </View>
    </HTWrapper>
  )
